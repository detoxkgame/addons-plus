...
odoo.define('skit_slide.slide_section_and_note_backend', function (require) {
...
var SectionAndNoteListRenderer = ListRenderer.extend({
    ...
    _onAddRecord: function (ev) {
        ...
        this.unselectRow().then(function () {
            ...
            else if (context && pyUtils.py_eval(context).open_content_form){
            	//alert('account')
                self._rpc({
                    model: 'ir.model.data',
                    method: 'xmlid_to_res_id',
                    kwargs: {xmlid: 'website_slides.view_slide_slide_form'},
                }).then(function (res_id) {
                    self.do_action({
