/* Generate a barcode for voucher code in "POS Coupon" receipt */
...
(function ($) {
  var barcode = {
    ...
    digitToCssRenderer : function($container, settings, digit, hri, mw, mh){
      ...
      var columns = digit[0].length;
      var content = "";
      var bar0 = "<div class='barcode-lines' style=\"float: left; font-size: 0px; background-color: " + settings.bgColor + "; height: " + mh + "px; width: &Wpx\"></div>";    
      var bar1 = "<div class='barcode-lines' style=\"float: left; font-size: 0px; width:0; border-left: &Wpx solid " + settings.color + "; height: " + mh + "px;\"></div>";
