    ...
    def _get_account_move_line_group_data_type_key(self, data_type, values, options={}):
        ...
        if data_type == 'product':
            ...
            return ('counter_part',
                    ...
                    values['account_id'],
                    values['debit'] > 0)
        elif data_type == 'cc_charge':
                return ('cc_charge', values['partner_id'],
                        values['account_id'], values['debit'] > 0)
        return False

    def _create_account_move_line(self, session=None, move=None):
        """" create account move line for credit card and other journal line """
        ...
        for order in self.filtered(lambda o: not o.account_move or o.state == 'paid'):
            ...
            for statement_id in order.statement_ids:
                if statement_id.journal_id.credit_card_charge>0:
