...
var DayTableMixin = FC.DayTableMixin = {
	...
	renderHeadDateCellsHtml: function() {
		...
		for (col = 0; col < 2; col++) {
			...
			htmls.push(this.renderResourceCellHtml(date,col,resources[col]));
	...
	renderResourceCellHtml: function(date, colspan, resource,otherAttrs) {
		var view = this.view;
		...
		return '' +
			'<th class="fc-day-header ' + view.widgetHeaderClass + ' fc-' + dayIDs[date.day()] + '"' +
				...
				view.buildGotoAnchorHtml(
					...
					htmlEscape(date.format(this.colHeadFormat),resources) // inner HTML
				) +
			'</th>';
	},
...
var View = FC.View = Class.extend(EmitterMixin, ListenerMixin, {
	...
	buildGotoAnchorHtml: function(gotoOptions, attrs, innerHtml,resource) {
		...
		if (!forceOff && this.opt('navLinks')) {
			...
			colspan = 1
//			return '<th class="fc-resource-cell"' + ' data-resource-id="' + 1 + '"' + (date ? ' data-date="' + date.format('YYYY-MM-DD') + '"' : '') + (colspan > 1 ? ' colspan="' + colspan + '"' : '') + '>' + htmlEscape('Room A') + '</th>';
			return '<span' + attrs + '>' +
				innerHtml +
				'</span>';
//			<th class="fc-resource-cell"' + ' data-resource-id="' + resource.id + '"' + (date ? ' data-date="' + date.format('YYYY-MM-DD') + '"' : '') + (colspan > 1 ? ' colspan="' + colspan + '"' : '') + '>' + htmlEscape(this.view.getResourceText(resource)) + '</th>';
		}
	},
