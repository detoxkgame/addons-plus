/* Odoo skit_web_resources
 * License AGPL-3.0 or later (http://www.gnu.org/licenses/agpl). */


odoo.define('skit_web_appointment.AppointmentView', function (require) {
    "use strict";

    var core = require('web.core');
   // var view_registry = require('web.view_registry');
    var AbstractView = require('web.AbstractView');
    var AppointmentRenderer = require('skit_web_appointment.AppointmentRenderer');
    var AppointmentModel = require('skit_web_appointment.AppointmentModel');
    var AppointmentController = require('skit_web_appointment.AppointmentController');
 ...
 // gather the fields to get
    ...
    var AppointmentView = AbstractView.extend({
        display_name: _lt('Appointment'),
        icon: 'fa-clock-o',
        jsLibs: ['/skit_web_appointment/static/lib/fullcalendar/js/fullcalendar.js'],
                 //'/skit_web_appointment/static/lib/fullcalendar/js/fullcalendar-columns.js'],
        cssLibs: ['/skit_web_appointment/static/lib/fullcalendar/css/fullcalendar.css'],
        config: {
