odoo.define('skit_web_appointment.AppointmentRenderer', function (require) {
"use strict";
...
var SidebarFilter = Widget.extend(FieldManagerMixin, {
    template: 'AppointmentView.sidebar.filter',
...
return AbstractRenderer.extend({
    ...
    _initCalendar: function () {
        ...
        var fc_options = $.extend({}, this.state.fc_options, {
            ...
            select: function (target_date, end_date, _js_event, _view,resourceIds) {
            	
                var data = {'start': target_date, 'end': end_date,'partner_ids': [resourceIds.id]};
            ...
            viewRender: function (view) {
                ...
                var mode = view.name ===  'month' ? 'month' : (view.name === 'agendaWeek' ? 'week' : 'multicolagenda');
    ...
    _render: function () {
        ...
        var $a;
//        alert('this.state.scale'+this.state.scale) //multiColAgendaDay
        switch (this.state.scale) {        
            ...
            case 'day': $a = this.$small_calendar.find('a.ui-state-active'); break;
            case 'multiColAgendaDay': $a = this.$small_calendar.find('a.ui-state-active'); break;
        }
        ...
        if (scrollTop) {
        	...
        	this.$calendar.fullCalendar('option', 'resources', this.state.fc_options.resources);
